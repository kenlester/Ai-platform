...
exports.promptOptimizer = exports.PromptOptimizer = void 0;
class PromptOptimizer {
    constructor() {
        this.maxTemplatesPerType = 50;
    ...
    recordTemplateUsage(taskType, template, variables, metrics) {
    ...
    analyzePromptEfficiency(prompt) {
...
exports.promptOptimizer = PromptOptimizer.getInstance();
//# sourceMappingURL=prompt_optimizer.js.map