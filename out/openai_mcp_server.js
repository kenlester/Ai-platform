                ...
                switch (request.params.name) {
                    case 'generate_text': {
                        if (!isGenerateTextArgs(request.params.arguments)) {
                            throw new types_js_1.McpError(types_js_1.ErrorCode.InvalidParams, 'Invalid generate_text arguments');
                        }
                    ...
                    case 'analyze_code': {
                        if (!isAnalyzeCodeArgs(request.params.arguments)) {
                            throw new types_js_1.McpError(types_js_1.ErrorCode.InvalidParams, 'Invalid analyze_code arguments');
                        }
                        const args = request.params.arguments;
...
//# sourceMappingURL=openai_mcp_server.js.map